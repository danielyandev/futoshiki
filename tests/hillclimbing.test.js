...
import { solveWithHillClimbing } from '../src/solvers/hillclimbing.js'
...
function solveWithSettings(settings) {
  ...
  for (let i = 0; i < iterations; i++) {
    ...
    const { solved, stats } = solveWithHillClimbing(board, 10)
    if (solved) {
      allStats.push(stats)
    } else {
      failures++
...
describe('HillClimbing solver', function () {
